...
public class FacilityStaffFunctions {
	...
	private void ticketStatusUpdateOptions(Scanner sc, List<Ticket> ticketToBeUpdated) {
		...
		try {
			...
			switch(statusOption) {
				case 1: ticketFn.updateTicketStatusAndSendNotifaction(ticketToBeUpdated.get(0), FacilityConstants.FIXED_STATUS);
				break;
				case 2: ticketFn.updateTicketStatusAndSendNotifaction(ticketToBeUpdated.get(0), FacilityConstants.ON_HOLD_STATUS);
				break;
