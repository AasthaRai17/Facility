...
public class FacilityConsumerFunctions {
	...
	private void viewAllTickets() {
		List<Ticket> currentConsumerTickets = FacilityConstants.TICKET_GENERIC_FUNCTIONS.viewAllTicketsLoggedByAPerson(currentConsumer.get(0));
	...
	private void createANewTicket(String ticketFacilityType, String typeOfTicket, String ticketDescription) {
		FacilityConstants.TICKET_GENERIC_FUNCTIONS.createANewTicketWithDefaultOwnerAsFacilityMgr(ticketFacilityType, typeOfTicket, ticketDescription, currentConsumer.get(0));
	}
